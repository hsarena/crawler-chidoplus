...
class MagazineSpider(scrapy.Spider):
    ...
    def magcat (self, argument):
        switcher = {
            ...
            'https://chidoplus.com/magcat/house-keeping/': 'خانه داری',
            'https://chidoplus.com/magcat/wood-furniture/': 'مبلمان و لوازم چوبی',
            'https://chidoplus.com/magcat/rebuilding/': 'بازسازی محل کار',
            'https://chidoplus.com/magcat/wall-floor/': 'کفپوش و دیوارپوش',
            'https://chidoplus.com/magcat/office-reconstruction/': 'بازسازی و خرید خانه',
